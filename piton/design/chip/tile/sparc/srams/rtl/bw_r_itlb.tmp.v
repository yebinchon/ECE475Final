...
input  	[`IC_TLB_TAG_MASK_ALL]    	cache_ptag;       	// way1 30b(D)/29b(I) tag.
input	[`IC_WAY_ARRAY_MASK]		cache_set_vld;       	// set vld-4 ways
...
output	[`IC_WAY_ARRAY_MASK]		cache_way_hit;		// tag comparison results.
...
wire	[`IC_TAG_HI:3]		phy_pgnum_m;
wire	[`IC_TAG_HI:0]		pgnum_m;
...
wire			cam_vld ;
wire			demap_other ;
wire	[`IC_WAY_ARRAY_MASK]   	cache_way_hit ;
...
reg	[`IC_TAG_HI:0]		pgnum_g ;
reg     [`IC_WAY_ARRAY_MASK]		cache_set_vld_g;
reg	[`IC_TLB_TAG_MASK_ALL]		cache_ptag_g;
...
always @(posedge clk)
		begin
			...
			cache_set_vld_g[`IC_WAY_ARRAY_MASK]  	<= cache_set_vld[`IC_WAY_ARRAY_MASK] ;
			cache_ptag_g[`IC_TLB_TAG_MASK_ALL] 	<= cache_ptag[`IC_TLB_TAG_MASK_ALL] ;
		end
...
//not_tested; // trin
   ...
   assign   cache_way_hit[0] = 
      (cache_ptag_g[`IC_TLB_TAG_NPARITY_WAY0_MASK] == pgnum_g[29 -: `IC_TAG_SZ]) & cache_set_vld_g[0] & cam_hit_any_or_bypass;


   assign   cache_way_hit[1] = 
      (cache_ptag_g[`IC_TLB_TAG_NPARITY_WAY1_MASK] == pgnum_g[29 -: `IC_TAG_SZ]) & cache_set_vld_g[1] & cam_hit_any_or_bypass;


   assign   cache_way_hit[2] = 
      (cache_ptag_g[`IC_TLB_TAG_NPARITY_WAY2_MASK] == pgnum_g[29 -: `IC_TAG_SZ]) & cache_set_vld_g[2] & cam_hit_any_or_bypass;


   assign   cache_way_hit[3] = 
      (cache_ptag_g[`IC_TLB_TAG_NPARITY_WAY3_MASK] == pgnum_g[29 -: `IC_TAG_SZ]) & cache_set_vld_g[3] & cam_hit_any_or_bypass;



assign	cache_hit = |cache_way_hit[`IC_WAY_ARRAY_MASK];
...
`else // is default implementation in openpiton
...
assign	tlb_pgnum_crit[39:10] = pgnum_m[29:0] ;
   ...
   assign   cache_way_hit[0] = 
      (cache_ptag_g[`IC_TLB_TAG_NPARITY_WAY0_MASK] == pgnum_g[29 -: `IC_TAG_SZ]) & cache_set_vld_g[0];


   assign   cache_way_hit[1] = 
      (cache_ptag_g[`IC_TLB_TAG_NPARITY_WAY1_MASK] == pgnum_g[29 -: `IC_TAG_SZ]) & cache_set_vld_g[1];


   assign   cache_way_hit[2] = 
      (cache_ptag_g[`IC_TLB_TAG_NPARITY_WAY2_MASK] == pgnum_g[29 -: `IC_TAG_SZ]) & cache_set_vld_g[2];


   assign   cache_way_hit[3] = 
      (cache_ptag_g[`IC_TLB_TAG_NPARITY_WAY3_MASK] == pgnum_g[29 -: `IC_TAG_SZ]) & cache_set_vld_g[3];
