...
`ifdef SIM_FPGA_SYN_SRAM_LSU_DCACHE // simulation flag
`define PITON_PROTO
`endif

`ifdef FPGA_FORCE_SRAM_LSU_DCACHE
`undef PITON_PROTO
`endif
...
`else // MERGE_L1_DCACHE == 1, use the parameterised implementation
...
`endif // MERGE_L1_DCACHE


`else // !SRAM_LSU_DCACHE
...
`endif // `ifndef SRAM_LSU_DCACHE // FPGA
